...
def generate_mask(real, fake, sigma):
    ...
    diff = (real.astype('float')-fake.astype('float')) ** 2
...
SAVEREALDIR = '../../data/dfdc/diffs2/reals/'
SAVEFAKEDIR = '../../data/dfdc/diffs2/fakes/'
SAVEMASKDIR = '../../data/dfdc/diffs2/masks/'
SAVEMIMGDIR = '../../data/dfdc/diffs2/mimgs/'
