...
plt.imshow(train_data[0][0].numpy().transpose(1,2,0).astype('uint8'))
plt.show()
plt.subplot(1,3,1)
plt.imshow(train_data[0]['orig'][2].numpy().transpose(1,2,0).astype('uint8'))
plt.subplot(1,3,2)
plt.imshow(train_data[0]['aug1'][2].numpy().transpose(1,2,0).astype('uint8'))
plt.subplot(1,3,3)
plt.imshow(train_data[0]['aug2'][2].numpy().transpose(1,2,0).astype('uint8'))
plt.show()
